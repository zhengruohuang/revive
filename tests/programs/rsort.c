// https://github.com/riscv/riscv-tests/blob/master/benchmarks/rsort/rsort.c
...
#else
static inline size_t fetch_add(size_t *ptr, size_t inc)
{
    size_t ori = *ptr;
    *ptr += inc;
    return ori;
...
int main( int argc, char* argv[] )
{
  ...
  int status = verify_u( DATA_SIZE, input_data, verify_data );
  printf("After verify: %d\n", status);
}
